    ...
    extends DCMIRecordType
{
     ...
     * 
     */
    public RecordType(final List<JAXBElement<SimpleLiteral>> dcElement, final List<EmptyType> anyText, final List<JAXBElement<? extends BoundingBoxType>> boundingBox) {
        super(dcElement);
