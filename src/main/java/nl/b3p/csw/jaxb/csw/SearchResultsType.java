...
public class SearchResultsType {
     ...
     * 
     */
    public SearchResultsType(final List<JAXBElement<? extends AbstractRecordType>> abstractRecord, final List<Element> any, final String resultSetId, final ElementSetType elementSet, final String recordSchema, final BigInteger numberOfRecordsMatched, final BigInteger numberOfRecordsReturned, final BigInteger nextRecord, final XMLGregorianCalendar expires) {
