    ...
    extends RequestBaseType
{
     ...
     * 
     */
    public HarvestType(final String service, final String version, final String source, final String resourceType, final String resourceFormat, final Duration harvestInterval, final List<String> responseHandler) {
