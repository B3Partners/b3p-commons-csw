...
public class AffinePlacementType {
     ...
     * 
     */
    public AffinePlacementType(final DirectPositionType location, final List<VectorType> refDirection, final BigInteger inDimension, final BigInteger outDimension) {
