...
public class MultiSurfacePropertyType {
    ...
    @XmlElementRef(name = "MultiSurface", namespace = "http://www.opengis.net/gml", type = MultiSurface.class)
     ...
     * 
     */
    public MultiSurfacePropertyType(final MultiSurface multiSurface, final String remoteSchema, final String type, final String href, final String role, final String arcrole, final String title, final String show, final String actuate) {
