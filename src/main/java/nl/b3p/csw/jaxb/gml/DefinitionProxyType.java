    ...
    extends DefinitionType
{
    ...
    @XmlElementRef(name = "definitionRef", namespace = "http://www.opengis.net/gml", type = DefinitionRef.class)
     ...
     * 
     */
    public DefinitionProxyType(final List<MetaDataProperty> metaDataProperty, final Description description, final List<Name> name, final String id, final DefinitionRef definitionRef) {
