...
public class PointPropertyType {
    ...
    @XmlElementRef(name = "Point", namespace = "http://www.opengis.net/gml", type = Point.class)
     ...
     * 
     */
    public PointPropertyType(final Point point, final String remoteSchema, final String type, final String href, final String role, final String arcrole, final String title, final String show, final String actuate) {
        this.point = point;
