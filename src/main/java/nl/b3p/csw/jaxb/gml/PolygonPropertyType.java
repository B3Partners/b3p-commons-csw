...
public class PolygonPropertyType {
    ...
    @XmlElementRef(name = "Polygon", namespace = "http://www.opengis.net/gml", type = Polygon.class)
     ...
     * 
     */
    public PolygonPropertyType(final Polygon polygon, final String remoteSchema, final String type, final String href, final String role, final String arcrole, final String title, final String show, final String actuate) {
