...
public class LineStringPropertyType {
    ...
    @XmlElementRef(name = "LineString", namespace = "http://www.opengis.net/gml", type = LineString.class)
     ...
     * 
     */
    public LineStringPropertyType(final LineString lineString, final String remoteSchema, final String type, final String href, final String role, final String arcrole, final String title, final String show, final String actuate) {
