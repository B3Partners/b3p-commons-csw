...
public class MultiGeometryPropertyType {
    ...
    @XmlElementRef(name = "_GeometricAggregate", namespace = "http://www.opengis.net/gml", type = GeometricAggregate.class)
     ...
     * 
     */
    public MultiGeometryPropertyType(final JAXBElement<? extends AbstractGeometricAggregateType> geometricAggregate, final String remoteSchema, final String type, final String href, final String role, final String arcrole, final String title, final String show, final String actuate) {
        this.geometricAggregate = geometricAggregate;
