...
public class OnlineResourceType {
     ...
     * 
     */
    public OnlineResourceType(final String type, final String href, final String role, final String arcrole, final String title, final String show, final String actuate) {
        this.type = type;
        this.href = href;
        this.role = role;
