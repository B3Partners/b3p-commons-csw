...
public class SpatialCapabilitiesType {
    ...
    @XmlElement(name = "GeometryOperands", namespace = "http://www.opengis.net/ogc", required = true)
    protected GeometryOperandsType geometryOperands;
    @XmlElement(name = "SpatialOperators", namespace = "http://www.opengis.net/ogc", required = true)
