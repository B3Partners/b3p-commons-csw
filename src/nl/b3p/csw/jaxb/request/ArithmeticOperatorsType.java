...
public class ArithmeticOperatorsType {
    ...
    @XmlElements({
        @XmlElement(name = "SimpleArithmetic", namespace = "http://www.opengis.net/ogc", type = SimpleArithmetic.class),
        @XmlElement(name = "Functions", namespace = "http://www.opengis.net/ogc", type = FunctionsType.class)
    })
