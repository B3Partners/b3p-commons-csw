...
public class LineStringSegmentArrayPropertyType {
    ...
    @XmlElementRef(name = "LineStringSegment", namespace = "http://www.opengis.net/gml", type = LineStringSegment.class)
     ...
     * 
     */
    public LineStringSegmentArrayPropertyType(final List<LineStringSegment> lineStringSegment) {
