    ...
    extends AbstractGriddedSurfaceType
{
     ...
     * 
     */
    public SphereType(final List<AbstractGriddedSurfaceType.Row> row, final BigInteger rows, final BigInteger columns, final CurveInterpolationType horizontalCurveType, final CurveInterpolationType verticalCurveType) {
