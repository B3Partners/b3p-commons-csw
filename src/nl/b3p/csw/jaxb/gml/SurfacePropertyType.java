...
public class SurfacePropertyType {
     ...
     * 
     */
    public SurfacePropertyType(final JAXBElement<? extends AbstractSurfaceType> surface, final String remoteSchema, final String type, final String href, final String role, final String arcrole, final String title, final String show, final String actuate) {
