...
public class DirectPositionListType {
     ...
     * 
     */
    public DirectPositionListType(final List<Double> value, final BigInteger count, final String srsName, final BigInteger srsDimension, final List<String> axisLabels, final List<String> uomLabels) {
        this.value = value;
        this.count = count;
