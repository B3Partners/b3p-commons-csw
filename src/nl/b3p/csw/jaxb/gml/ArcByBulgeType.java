    ...
    extends ArcStringByBulgeType
{
     ...
     * 
     */
    public ArcByBulgeType(final BigInteger numDerivativesAtStart, final BigInteger numDerivativesAtEnd, final BigInteger numDerivativeInterior, final List<JAXBElement<?>> posOrPointPropertyOrPointRep, final PosList posList, final Coordinates coordinates, final List<Double> bulge, final List<VectorType> normal, final CurveInterpolationType interpolation, final BigInteger numArc) {
        super(numDerivativesAtStart, numDerivativesAtEnd, numDerivativeInterior, posOrPointPropertyOrPointRep, posList, coordinates, bulge, normal, interpolation, numArc);
    }
