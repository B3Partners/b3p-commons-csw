...
public class GeometricPrimitivePropertyType {
    ...
    @XmlElementRef(name = "_GeometricPrimitive", namespace = "http://www.opengis.net/gml", type = GeometricPrimitive.class)
     ...
     * 
     */
    public GeometricPrimitivePropertyType(final JAXBElement<? extends AbstractGeometricPrimitiveType> geometricPrimitive, final String remoteSchema, final String type, final String href, final String role, final String arcrole, final String title, final String show, final String actuate) {
