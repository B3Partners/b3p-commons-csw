...
public class MultiPointPropertyType {
    ...
    @XmlElementRef(name = "MultiPoint", namespace = "http://www.opengis.net/gml", type = MultiPoint.class)
     ...
     * 
     */
    public MultiPointPropertyType(final MultiPoint multiPoint, final String remoteSchema, final String type, final String href, final String role, final String arcrole, final String title, final String show, final String actuate) {
