    ...
    extends GeodesicStringType
{
     ...
     * 
     */
    public GeodesicType(final BigInteger numDerivativesAtStart, final BigInteger numDerivativesAtEnd, final BigInteger numDerivativeInterior, final PosList posList, final List<JAXBElement<?>> geometricPositionGroup, final CurveInterpolationType interpolation) {
        super(numDerivativesAtStart, numDerivativesAtEnd, numDerivativeInterior, posList, geometricPositionGroup, interpolation);
    }
