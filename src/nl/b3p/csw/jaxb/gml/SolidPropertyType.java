...
public class SolidPropertyType {
     ...
     * 
     */
    public SolidPropertyType(final JAXBElement<? extends AbstractSolidType> solid, final String remoteSchema, final String type, final String href, final String role, final String arcrole, final String title, final String show, final String actuate) {
        this.solid = solid;
