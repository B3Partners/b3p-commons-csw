...
public class EnvelopeType {
     ...
     * 
     */
    public EnvelopeType(final DirectPositionType lowerCorner, final DirectPositionType upperCorner, final List<Coord> coord, final List<Pos> pos, final Coordinates coordinates, final String srsName, final BigInteger srsDimension, final List<String> axisLabels, final List<String> uomLabels) {
