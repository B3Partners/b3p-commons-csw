...
public class MultiSolidPropertyType {
    ...
    @XmlElementRef(name = "MultiSolid", namespace = "http://www.opengis.net/gml", type = MultiSolid.class)
     ...
     * 
     */
    public MultiSolidPropertyType(final MultiSolid multiSolid, final String remoteSchema, final String type, final String href, final String role, final String arcrole, final String title, final String show, final String actuate) {
