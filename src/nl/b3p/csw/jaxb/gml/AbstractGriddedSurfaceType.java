    ...
    extends AbstractParametricCurveSurfaceType
{
     ...
     * 
     */
    public AbstractGriddedSurfaceType(final List<AbstractGriddedSurfaceType.Row> row, final BigInteger rows, final BigInteger columns) {
        super();
        this.row = row;
        this.rows = rows;
    ...
    public static class Row {
         ...
         * 
         */
        public Row(final PosList posList, final List<JAXBElement<?>> geometricPositionGroup) {
