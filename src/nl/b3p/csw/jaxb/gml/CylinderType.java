    ...
    extends AbstractGriddedSurfaceType
{
     ...
     * 
     */
    public CylinderType(final List<AbstractGriddedSurfaceType.Row> row, final BigInteger rows, final BigInteger columns, final CurveInterpolationType horizontalCurveType, final CurveInterpolationType verticalCurveType) {
        super(row, rows, columns);
