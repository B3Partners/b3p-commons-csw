...
public class StringOrRefType {
     ...
     * 
     */
    public StringOrRefType(final String value, final String remoteSchema, final String type, final String href, final String role, final String arcrole, final String title, final String show, final String actuate) {
        this.value = value;
