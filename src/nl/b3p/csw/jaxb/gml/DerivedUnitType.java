    ...
    extends UnitDefinitionType
{
     ...
     * 
     */
    public DerivedUnitType(final List<MetaDataProperty> metaDataProperty, final Description description, final List<Name> name, final String id, final QuantityType quantityType, final CatalogSymbol catalogSymbol, final List<DerivationUnitTerm> derivationUnitTerm) {
