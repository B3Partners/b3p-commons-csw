    ...
    extends AbstractCurveSegmentType
{
     ...
     * 
     */
    public BSplineType(final BigInteger numDerivativesAtStart, final BigInteger numDerivativesAtEnd, final BigInteger numDerivativeInterior, final List<JAXBElement<?>> posOrPointPropertyOrPointRep, final PosList posList, final Coordinates coordinates, final BigInteger degree, final List<KnotPropertyType> knot, final CurveInterpolationType interpolation, final Boolean isPolynomial, final KnotTypesType knotType) {
