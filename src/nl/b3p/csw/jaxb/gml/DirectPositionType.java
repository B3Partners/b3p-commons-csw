...
public class DirectPositionType {
     ...
     * 
     */
    public DirectPositionType(final List<Double> value, final String srsName, final BigInteger srsDimension, final List<String> axisLabels, final List<String> uomLabels) {
        this.value = value;
