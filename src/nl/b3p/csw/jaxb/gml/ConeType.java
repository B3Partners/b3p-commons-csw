    ...
    extends AbstractGriddedSurfaceType
{
     ...
     * 
     */
    public ConeType(final List<AbstractGriddedSurfaceType.Row> row, final BigInteger rows, final BigInteger columns, final CurveInterpolationType horizontalCurveType, final CurveInterpolationType verticalCurveType) {
