...
public class DictionaryEntryType {
    ...
    @XmlElementRef(name = "Definition", namespace = "http://www.opengis.net/gml", type = Definition.class)
     ...
     * 
     */
    public DictionaryEntryType(final JAXBElement<? extends DefinitionType> definition, final String remoteSchema, final String type, final String href, final String role, final String arcrole, final String title, final String show, final String actuate) {
