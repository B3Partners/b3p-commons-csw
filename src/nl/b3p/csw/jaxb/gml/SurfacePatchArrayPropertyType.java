...
public class SurfacePatchArrayPropertyType {
    ...
    @XmlElementRef(name = "_SurfacePatch", namespace = "http://www.opengis.net/gml", type = SurfacePatch.class)
     ...
     * 
     */
    public SurfacePatchArrayPropertyType(final List<JAXBElement<? extends AbstractSurfacePatchType>> surfacePatch) {
