    ...
    extends DefinitionType
{
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "dictionaryEntry", namespace = "http://www.opengis.net/gml", type = DictionaryEntry.class),
        @XmlElementRef(name = "indirectEntry", namespace = "http://www.opengis.net/gml", type = IndirectEntry.class)
    })
     ...
     * 
     */
    public DictionaryType(final List<MetaDataProperty> metaDataProperty, final Description description, final List<Name> name, final String id, final List<JAXBElement<?>> dictionaryEntryOrIndirectEntry) {
