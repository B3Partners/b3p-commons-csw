...
public class ScalarCapabilitiesType {
     ...
     * 
     */
    public ScalarCapabilitiesType(final LogicalOperators logicalOperators, final ComparisonOperatorsType comparisonOperators, final ArithmeticOperatorsType arithmeticOperators) {
