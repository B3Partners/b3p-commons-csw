...
public class OperationsMetadata {
     ...
     * 
     */
    public OperationsMetadata(final List<Operation> operation, final List<DomainType> parameter, final List<DomainType> constraint, final ExtendedCapabilities extendedCapabilities) {
