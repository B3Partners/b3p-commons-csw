...
@XmlSeeAlso({
    nl.b3p.csw.jaxb.csw.GetCapabilitiesType.class
})
public class GetCapabilitiesType {
     ...
     * 
     */
    public GetCapabilitiesType(final AcceptVersionsType acceptVersions, final SectionsType sections, final AcceptFormatsType acceptFormats, final String updateSequence) {
