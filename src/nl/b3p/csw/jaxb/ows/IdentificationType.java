    ...
    extends DescriptionType
{
     ...
     * 
     */
    public IdentificationType(final Title title, final Abstract _abstract, final List<Keywords> keywords, final Identifier identifier, final List<JAXBElement<? extends BoundingBoxType>> boundingBox, final List<OutputFormat> outputFormat, final List<JAXBElement<String>> availableCRS, final List<Metadata> metadata) {
