    ...
    extends BoundingBoxType
{
     ...
     * 
     */
    public WGS84BoundingBoxType(final List<Double> lowerCorner, final List<Double> upperCorner, final String crs, final BigInteger dimensions) {
        super(lowerCorner, upperCorner, crs, dimensions);
    }
