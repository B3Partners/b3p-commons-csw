    ...
    extends RequestBaseType
{
     ...
     * 
     */
    public GetRecordsType(final String service, final String version, final DistributedSearchType distributedSearch, final List<String> responseHandler, final JAXBElement<? extends AbstractQueryType> abstractQuery, final Object any, final String requestId, final ResultType resultType, final String outputFormat, final String outputSchema, final BigInteger startPosition, final BigInteger maxRecords) {
