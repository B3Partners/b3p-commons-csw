    ...
    extends RequestBaseType
{
     ...
     * 
     */
    public TransactionType(final String service, final String version, final List<Object> insertOrUpdateOrDelete, final Boolean verboseResponse, final String requestId) {
        super(service, version);
        this.insertOrUpdateOrDelete = insertOrUpdateOrDelete;
