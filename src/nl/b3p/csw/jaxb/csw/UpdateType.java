...
public class UpdateType {
     ...
     * 
     */
    public UpdateType(final Object any, final List<RecordProperty> recordProperty, final Constraint constraint, final String handle) {
        this.any = any;
    ...
    public List<RecordProperty> getRecordProperty() {
        if (recordProperty == null) {
            recordProperty = new ArrayList<RecordProperty>();
        }
