...
public class CswClient {
    ...
    public Output search(Input input)
        ...
        JAXBElement<? extends RequestBaseType> request = input.getRequest();

        String marshalledCswXml = MarshallUtil.marshall(request);
        ...
        try {
            Document xmlDocument = builder.build(new StringReader(xmlResponse));
    ...
    public static void main(String[] args) {
        ...
        try {
            System.out.println(MarshallUtil.marshall(input.getRequest()));
            /*SAXBuilder builder = new SAXBuilder(VALIDATE_CSW_RESPONSE);
            ...
            Input getIdInput = new Input(CswRequestCreator.createGetRecordByIdRequest(
            ...
            System.out.println(MarshallUtil.marshall(getIdInput.getRequest()));
            Output getIdOutput = client.search(getIdInput);

            Document getIdOutputXmlDoc = getIdOutput.getXml();
