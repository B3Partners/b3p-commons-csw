...
public class ItemDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ItemDescriptor() 
     {
        ...
        desc.setValidator(fieldValidator);
        //-- _resourceList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(nl.b3p.csw.client.castor.simpleResponse.Resource.class, "_resourceList", "resource", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Item target = (Item) object;
                    target.addResource( (nl.b3p.csw.client.castor.simpleResponse.Resource) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new nl.b3p.csw.client.castor.simpleResponse.Resource();
            }
        };
        desc.setHandler(handler);
        ...
        desc.setValidator(fieldValidator);
    } //-- nl.b3p.csw.client.castor.simpleResponse.ItemDescriptor()
    ...
    {
        return nl.b3p.csw.client.castor.simpleResponse.Item.class;
