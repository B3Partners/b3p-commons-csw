...
/**
 * Class SearchStatusDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class SearchStatusDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public SearchStatusDescriptor() 
     {
        super();
        nsURI = "http://www.opengis.net/cat/csw/2.0.2";
        xmlName = "SearchStatus";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                SearchStatus target = (SearchStatus) object;
    ...
    } //-- nl.b3p.csw.client.castor.cswResponse.SearchStatusDescriptor()
    ...
    {
        return nl.b3p.csw.client.castor.cswResponse.SearchStatus.class;
